...
const rows: { key: keyof NotificationPrefs; label: string; hint: string }[] = [
  ...
  },
  {
    ...
    hint: "ดีล ส่วนลด และแคมเปญจากร้าน (ตอนนี้เก็บความชอบในเบราว์เซอร์)",
  },
  {
    key: "email_stock_alerts",
    label: "แจ้งเตือนเมื่อสินค้ากลับมา",
    hint: "ควบคู่กับรายการรอแจ้งบนหน้าเว็บ — การส่งอีเมลยังไม่เปิดใช้งาน (ดูหน้าแจ้งเตือนสต็อก)",
  },
  {
    key: "email_product_recommendations",
    label: "สินค้าแนะนำส่วนบุคคล",
    hint: "อีเมลแนะนำสินค้าตามความสนใจ (ตอนนี้ยังไม่ส่งอีเมล — เก็บความชอบในเบราว์เซอร์)",
  },
];
      ...
      <main className="mx-auto max-w-xl space-y-8 px-4 py-10">
        <div>
          ...
          <p className="mt-2 text-sm text-stone-600 dark:text-stone-400">
            เลือกประเภทการแจ้งเตือนที่ต้องการ — ตอนนี้บันทึกในเบราว์เซอร์; เมื่อเชื่อมผู้ให้บริการอีเมลแล้วสามารถซิงก์ไปเซิร์ฟเวอร์ได้
          </p>
        </div>
